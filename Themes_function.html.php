  ...
  <table width="95%">
    <tr>
      <td width="100%" style="font-size:14px; font-weight:bold">
        <a href="https://web-dorado.com/spider-calendar-wordpress-guide-step-5/5-1.html" target="_blank" style="color:blue; text-decoration:none;"><?php _e( 'User Manual', 'sp_calendar' ); ?></a><br />
        <?php _e( 'This section allows you to create/edit themes for the calendars.', 'sp_calendar' ); ?><br />
        <?php _e( 'This feature is disabled for the non-commercial version.', 'sp_calendar' ); ?>
        <a href="https://web-dorado.com/spider-calendar-wordpress-guide-step-5/5-1.html" target="_blank" style="color:blue; text-decoration:none;"><?php _e( 'More...', 'sp_calendar' ); ?></a><br />
        <?php _e( 'Here are some examples of 17 standard templates included in the commercial version.', 'sp_calendar' ); ?>
